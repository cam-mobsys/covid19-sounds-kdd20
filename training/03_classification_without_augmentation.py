# -*- coding: utf-8 -*-
"""
Description: This the third stage of the processing pipeline that is used to predict, based on an audio sample of
respiratory sounds, the prevalence of COVID-19 infection.

Stage 3: Combining features and training the binary classifier for prediction-normally two categories of features 
should be involved.
...
if __name__ == "__main__":
    ...
    for features in [
        ...
        output = open("subset" + str(features) + "_tasks_svm_auc_noaug.csv", "wb")
        head = [
            "Tasks",
            "Train",
            "Test",
        ...
        for n in [0.7, 0.8, 0.9, 0.95]:  
            ...
            for i1 in ["task1", "task2", "task3"]:
                ...
                if i1 == "task3":
                    #using sample from: 
                    #positive:covidandroidwithcough  + covidwebwithcough  
                    #negaive: asthmaandroidwithcough  + asthmawebwithcough
                    x_data_all_task = np.concatenate(
                ...
                for i2 in ["breath", "cough", "breath_cough"]:  # multi-modal
                    ...
                    # repeat experiments for time times
                    ...
                    #save results to the csv files, each metric is presented in mean(std) across ten experiments
                    if i2 == "breath":  
                        line.append(
